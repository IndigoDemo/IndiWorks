define([], function() {
    ...
    JSRocket.SyncDevice = function (origin) {
        JSRocket.that = origin;
        ...
        function deviceReady() {
            _connected = true;
            _eventHandler.ready(JSRocket.that);
        }

        function deviceUpdate(row) {
            _eventHandler.update(JSRocket.that, row);
        }

        function devicePlay() {
            _eventHandler.play(JSRocket.that);
        }

        function devicePause() {
            _eventHandler.pause(JSRocket.that);
        }
